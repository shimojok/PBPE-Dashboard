...
包括的な数理モデルと理論的枠組みについては以下をご覧ください：
- [統合的PBPEモデル：気候変動ファイナンス革新体系](./docs/ja/07_統合的PBPEモデル.md)
- [PBPEアーキテクチャ詳細](./docs/ja/01_PBPEアーキテクチャ.md)
- [資本フローマップと金融モデル](./docs/ja/03_資本フローマップ.md)
- [インパクト指標とMRVフレームワーク](./docs/ja/04_インパクト指標.md)
